...
<div class="running-page" data-race-showcase>
  <section class="running-hero reveal">
    <div class="running-hero__copy">
      ...
      <h1 data-en="Mountain data, race memory, forward motion." data-zh="山野数据、比赛记忆、持续向前。">Mountain data, race memory, forward motion.</h1>
      <p class="running-hero__text" data-en="A compact dashboard for personal bests, race days, route images, and the small signals that make training feel alive." data-zh="一个记录个人最佳、比赛日、路线影像和训练信号的运动仪表盘。">A compact dashboard for personal bests, race days, route images, and the small signals that make training feel alive.</p>
    </div>
  ...
  <section class="running-intro reveal" aria-labelledby="personal-bests-title">
    <div class="section-heading">
      <p data-en="Personal telemetry" data-zh="个人数据">Personal telemetry</p>
      <h2 id="personal-bests-title" data-en="Personal Best Records" data-zh="个人最佳成绩">Personal Best Records</h2>
    </div>
    <div class="pb-grid">
      <div class="pb-card">
    ...
    <article class="race-card race-card--featured" aria-live="polite">
      <div class="race-image-carousel" data-race-carousel data-autoplay="true" data-interval="5200" tabindex="0" aria-label="Dongmingshan race image carousel">
        <div class="race-images" aria-live="polite">
          ...
          <img src="/images/races/dongmingshan-map.jpg" alt="Dongmingshan race route map" class="is-map" data-caption="Route map / 20.94 km" data-caption-zh="路线图 / 20.94 公里" data-fit="contain">
        </div>
        <button class="carousel-btn prev" type="button" aria-label="Previous image"><i class="fa-solid fa-chevron-left" aria-hidden="true"></i></button>
        <button class="carousel-btn next" type="button" aria-label="Next image"><i class="fa-solid fa-chevron-right" aria-hidden="true"></i></button>
        <div class="carousel-status" aria-live="polite">1 / 3</div>
        <div class="carousel-caption" data-en="Trail climb / Dongmingshan" data-zh="爬坡路段 / 东明山">Trail climb / Dongmingshan</div>
        <div class="carousel-dots" aria-label="Choose image"></div>
        <div class="carousel-thumbs" aria-label="Image thumbnails"></div>
      </div>
      ...
      <div class="race-details">
        ...
        <dl class="race-metrics" data-race-metrics>
          ...
          <div>
            <dt data-en="Distance" data-zh="距离">Distance</dt>
            <dd>20.94 km</dd>
          </div>
          <div>
            <dt data-en="Elevation" data-zh="爬升">Elevation</dt>
            <dd>1116 m</dd>
          </div>
          <div>
  ...
  <section class="race-section reveal" aria-labelledby="trail-races-title">
    <div class="section-heading">
      <p data-en="Race archive" data-zh="赛事档案">Race archive</p>
      <h2 id="trail-races-title" data-en="Trail Running Races" data-zh="越野跑比赛">Trail Running Races</h2>
    </div>
    ...
    <div class="races-grid" id="trail-races">
      ...
      <article class="race-card race-card--selectable" data-race-card role="button" tabindex="0" aria-pressed="false" aria-label="Show Mountain Session details">
        ...
        <div class="race-details">
          <div class="race-details__topline">
            <span data-en="Training" data-zh="训练">Training</span>
            <span data-en="Photo Log" data-zh="影像记录">Photo Log</span>
          </div>
          <h3 class="race-name" data-en="Mountain Session" data-zh="山地训练">Mountain Session</h3>
          <p class="race-note" data-en="Landscape frame for future race notes." data-zh="横图照片位，可补充后续比赛记录。">Landscape frame for future race notes.</p>
        </div>
      </article>
      ...
      <article class="race-card race-card--selectable" data-race-card role="button" tabindex="0" aria-pressed="false" aria-label="Show Trail Memory details">
        ...
        <div class="race-details">
          <div class="race-details__topline">
            <span data-en="Race Day" data-zh="比赛日">Race Day</span>
            <span data-en="Vertical" data-zh="竖图">Vertical</span>
          </div>
          <h3 class="race-name" data-en="Trail Memory" data-zh="越野记忆">Trail Memory</h3>
          <p class="race-note" data-en="Portrait images stay stable inside the same responsive frame." data-zh="竖图会在统一自适应容器内稳定展示。">Portrait images stay stable inside the same responsive frame.</p>
        </div>
      </article>
    </div>
  </section>
  ...
  <section class="race-section reveal" aria-labelledby="relay-races-title">
    ...
    <div class="races-grid" id="relay-races">
      <article class="race-card">
        <div class="race-image">
          <img src="/images/races/race-03.jpg" alt="Great Wall Relay League photo" class="is-portrait">
        </div>
        <div class="race-details">
          <div class="race-details__topline">
            <span data-en="Relay" data-zh="接力">Relay</span>
            <span data-en="Team" data-zh="团队">Team</span>
          </div>
          <h3 class="race-name" data-en="Great Wall Relay League" data-zh="长城接力联赛">Great Wall Relay League</h3>
          <p class="race-note" data-en="Team event record with room for split data and course notes." data-zh="团队赛事记录，可补充分段数据和路线备注。">Team event record with room for split data and course notes.</p>
        </div>
      </article>
    </div>
  </section>
